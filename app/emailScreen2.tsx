...
export default function EmailScreen2() {
const router = useRouter();
  ...
  return (
    ...
    <SafeAreaView className="flex-1 p-8" style={{backgroundColor: '#1D1A37'}}>
      ...
      <View className="justify-center items-center"><Text className="text-white text-2xl">Enter Wallet</Text></View>
      ...
      <TouchableOpacity className="flex-1 justify-end" onPress={() => router.push('/loginScreen')}>
